...
export const PRODUCT_VILLE_LIST_REQUEST = 'PRODUCT_VILLE_LIST_REQUEST';
export const PRODUCT_VILLE_LIST_SUCCESS = 'PRODUCT_VILLE_LIST_SUCCESS';
export const PRODUCT_VILLE_LIST_FAIL = 'PRODUCT_VILLE_LIST_FAIL';
